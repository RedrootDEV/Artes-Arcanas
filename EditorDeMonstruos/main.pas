...
begin
  ...
  begin
    ...
    C_ZonaCivilizada.checked:=(terreno and ft_TerrenoSuave)<>0;
    ...
    CB_Tesoro2.ItemIndex:=tesoro2;
    E_ModTesoro2.text:=inttostr(ModificadorTesoro2);
...
begin
  ...
  if C_ZonaCivilizada.Checked then
    terreno:=terreno or ft_TerrenoSuave;
  ...
  begin
    ...
    ModificadorTesoro2:=valor(E_ModTesoro2.text,0,255);
    HPPromedio:=valor(E_HPB.text,0,MAX_DEMONIO_HP);
    tesoro:=CB_tesoro.ItemIndex;
    tesoro2:=CB_tesoro2.ItemIndex;
